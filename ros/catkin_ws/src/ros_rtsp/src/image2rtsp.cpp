...
GstCaps* Image2RTSPNodelet::gst_caps_new_from_image(const sensor_msgs::ImageConstPtr &msg)
{
    ...
    return gst_caps_new_simple("video/x-raw",
            ...
            "framerate", GST_TYPE_FRACTION, 100, 1,    //频率
            nullptr);
}


void Image2RTSPNodelet::imageCallback(const sensor_msgs::ImageConstPtr& msg, const std::string& topic) {
    
    std::cout << "test: " << msg->width  << std::endl;
