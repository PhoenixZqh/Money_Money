...
private:
    ...
    // GstCaps* gst_caps_new_from_image(const sensor_msgs::CompressedImageConstPtr &msg);
    ...
    // GstRTSPServer* rtsp_server_create(const std::string& ip_address, const std::string& port);
};
}
